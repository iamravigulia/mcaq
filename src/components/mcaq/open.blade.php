<div>
    ...
    <form action="{{route('fmt.mcaq.store')}}" method="post" class="fmt_box" enctype="multipart/form-data">
        ...
        <div class="fmt_headline">Add a MCaQ</div>
        <div>
        ...
        <div>
            <label class="fmt_label" for="">Question Media</label>
            <input style="margin-top:10px;" type="file" accept="audio/*" name="question_media" id=""required>
        </div>
        <div>
        ...
        <div class="fmt_flex">
            <div>
                <label class="fmt_label" for="">Answer 7</label>
                <input class="fmt_input" type="text" name="answer_7" placeholder="Answer">
            </div>
            <div>
                <label class="fmt_label" for="">Correct</label>
                <input class="fmt_checkbox" type="checkbox" name="ans_correct_7" id="">
            </div>
            <div style="margin-left: 10px;">
        ...
        <div class="fmt_flex">
            <div>
                <label class="fmt_label" for="">Answer 8</label>
                <input class="fmt_input" type="text" name="answer_8" placeholder="Answer">
            </div>
            <div>
                <label class="fmt_label" for="">Correct</label>
                <input class="fmt_checkbox" type="checkbox" name="ans_correct_8" id="">
            </div>
            <div style="margin-left: 10px;">
...
{{--  --}}
<form action="{{route('fmt.mcaq.csv')}}" method="POST" enctype='multipart/form-data' style="margin:20px 40px;">
    @csrf
    <input type="integer" name="problem_set_id" value="{{$pbs72 ?? ''}}" hidden style="border:1px solid #000000;">
    <input type="integer" name="format_type_id" value="{{$fmt72 ?? ''}}" hidden style="border:1px solid #000000;">
